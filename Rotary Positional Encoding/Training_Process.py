...
sequence_len=64 # sequence length of time series
...
plt.title('Rotary PE training losses vs. validation losses')
plt.xlabel('Epochs')
plt.ylabel('Losses (%)')
...
plt.title('Rotary PE training vs. validation accuracy')
plt.xlabel('Epochs')
...
plt.title('Rotary PE training and validation accuracy vs. loss', fontdict={'size': 14, 'family': 'Times New Roman'})
...
plt.title("Rotary Positional Encoding Confusion Matrix", fontdict={'size': 14, 'family': 'Times New Roman'})
...
plt.title("Rotary Positional Encodings AUC ROC Curve", fontdict={'size': 14, 'family': 'Times New Roman'})
